  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Our Termite Treatment?</h3>
        ...
        {/* Treatment Process */}
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Termite Treatment Process</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">
                Professional termite treatment services for residential and commercial properties.
              </p>
            </div>
